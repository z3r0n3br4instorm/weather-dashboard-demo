    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="mb-6">
                    <h1 class="text-2xl font-bold">Add New Sensor</h1>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <div class="mb-4">
                                ...
                                <input type="text" name="sensor_id" id="sensor_id" value="{{ old('sensor_id') }}"
                        ...
                        <div>
                            <div class="mb-4">
                                ...
                                <input type="number" step="0.0000001" name="latitude" id="latitude" value="{{ old('latitude') }}"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" step="0.0000001" name="longitude" id="longitude" value="{{ old('longitude') }}"
...
<script>
    ...
    // Create a marker
    let marker = L.marker([6.9271, 79.8612], {
        draggable: true
    }).addTo(map);
